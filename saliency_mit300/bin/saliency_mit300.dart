...
String _generatePerformancePlot(List<ModelResults> modelResults,
  ...
  return '\\begin{figure}\n'
      ...
      '\\end{tikzpicture}\n'
      '\\caption[Performance of various saliency map prediction models, '
      'measured by the NSS score each model achieved '
      'on the ${dataset.toUpperCase()} dataset.]{Performance of various '
      'saliency map prediction models, measured by the NSS score each model '
      'achieved '
      ...
      'and are colored in \\textcolor{black}{black} or \\textcolor{SteelBlue}'
      '{blue}, respectively. '
      'Models drawn with a dark color are present in '
      'Table~\\ref{$tableReference}. '
      'Only models whose release date is present in '
      '\\cite{mit-saliency-benchmark, mit-tuebingen-saliency-benchmark} '
      'are included. '
